...
/**
 * Code to use the configuration from canvas.config in the provided code. You
 * don't need to interact with this class
 * 
 * @author CS1331 TAs
 * @version 1
 */
                    ...
                    switch (lineInfo[0]) {
                        ...
                        case "pixelSize":
                            if (lineInfo.length >= 2) {
                                try {
                                    CanvasConfig.pixelSize = Integer.parseInt(lineInfo[1]);
                        ...
                        case "borderSize":
                            if (lineInfo.length >= 2) {
                                try {
                                    CanvasConfig.borderSize = Integer.parseInt(lineInfo[1]);
